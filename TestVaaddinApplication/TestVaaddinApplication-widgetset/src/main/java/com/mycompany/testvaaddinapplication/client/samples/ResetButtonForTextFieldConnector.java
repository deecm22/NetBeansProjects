package com.mycompany.testvaaddinapplication.client.samples;
...
import com.mycompany.testvaaddinapplication.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@com.mycompany.testvaaddinapplication.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
