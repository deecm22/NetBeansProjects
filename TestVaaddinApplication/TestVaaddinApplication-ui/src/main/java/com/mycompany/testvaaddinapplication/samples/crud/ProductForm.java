package com.mycompany.testvaaddinapplication.samples.crud;

import java.util.Collection;

import com.mycompany.testvaaddinapplication.samples.backend.DataService;
import com.mycompany.testvaaddinapplication.samples.backend.data.Availability;
