...
- TestVaaddinApplication-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- TestVaaddinApplication-ui: main application module, development time
- TestVaaddinApplication-production: module that produces a production mode WAR for deployment
