...
- testVaadin-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- testVaadin-ui: main application module, development time
- testVaadin-production: module that produces a production mode WAR for deployment
