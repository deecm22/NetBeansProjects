package com.mycompany.testvaadin.samples.crud;

import java.util.Collection;

import com.mycompany.testvaadin.samples.backend.DataService;
import com.mycompany.testvaadin.samples.backend.data.Availability;
