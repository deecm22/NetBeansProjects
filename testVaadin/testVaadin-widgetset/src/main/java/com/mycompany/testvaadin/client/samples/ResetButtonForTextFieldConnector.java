package com.mycompany.testvaadin.client.samples;
...
import com.mycompany.testvaadin.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@com.mycompany.testvaadin.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
